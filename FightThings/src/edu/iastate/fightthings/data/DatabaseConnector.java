...
//   public DummyItem getOneDummyItem(long id)
//   {
//	   Cursor result = getOneContact(id);
//	   
...
//       
//       return new DummyItem(id + "", result.getString(nameIndex));
//   }
   ...
   private class DatabaseOpenHelper extends SQLiteOpenHelper 
   {
      ...
      {
          ContentValues newContact = new ContentValues();
          newContact.put("name", "test1");
          newContact.put("email", "test1");
          newContact.put("phone", "test1");
          newContact.put("street", "test1");
          newContact.put("city", "test1");
