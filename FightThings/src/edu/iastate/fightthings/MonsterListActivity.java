...
/**
 * An activity representing a list of Monsters. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link MonsterDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link MonsterListFragment} and the item details (if present) is a
 * {@link MonsterDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link MonsterListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class MonsterListActivity extends FragmentActivity implements
	...
	/**
	 * Callback method from {@link MonsterListFragment.Callbacks} indicating
