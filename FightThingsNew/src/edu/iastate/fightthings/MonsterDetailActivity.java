...
public class MonsterDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(MonsterDetailFragment.ARG_ITEM_ID, getIntent()
					.getStringExtra(MonsterDetailFragment.ARG_ITEM_ID));
			MonsterDetailFragment fragment = new MonsterDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.monster_detail_container, fragment).commit();
		}
	}
